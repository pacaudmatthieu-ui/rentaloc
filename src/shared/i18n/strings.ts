...
export const STRINGS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    taxRegimeComparisonFlatTaxNote: 'Note: Flat tax (PFU) is not included in the calculations unless explicitly enabled for SCI IS withdrawals.',
    taxRegimeComparisonSciIsWithdrawFlatTax: 'Apply flat tax (PFU) on withdrawal for {simulation}',
    taxRegimeComparisonFlatTaxDetailTitle: 'Flat tax (PFU) calculation detail',
    taxRegimeComparisonFlatTaxAccumulatedPerYear: 'Amount left in company (after corporate tax)',
    taxRegimeComparisonFlatTaxYear: 'Year {year}',
    taxRegimeComparisonFlatTaxSumAnnual: 'Sum of amounts left during holding',
    taxRegimeComparisonFlatTaxResaleNet: 'Resale net (sale price − loan balance − corporate tax on gain)',
    taxRegimeComparisonFlatTaxTotalAccumulated: 'Total accumulated (not withdrawn)',
    taxRegimeComparisonFlatTaxRate: 'Flat tax rate (PFU)',
    taxRegimeComparisonFlatTaxAmount: 'Flat tax on withdrawal',
    taxRegimeComparisonFlatTaxCorporateOnGain: 'Corporate tax on capital gain',
    taxRegimeComparisonFlatTaxTotalResaleTax: 'Total resale tax (corporate + flat tax)',
  },
  fr: {
    ...
    taxRegimeComparisonFlatTaxNote: 'Note : La flat tax (PFU) n\'est pas prise en compte dans les calculs sauf si explicitement activée pour les retraits SCI IS.',
    taxRegimeComparisonSciIsWithdrawFlatTax: 'Appliquer la flat tax (PFU) sur le retrait pour {simulation}',
    taxRegimeComparisonFlatTaxDetailTitle: 'Détail du calcul de la flat tax (PFU)',
    taxRegimeComparisonFlatTaxAccumulatedPerYear: 'Montant laissé en société (après IS)',
    taxRegimeComparisonFlatTaxYear: 'Année {year}',
    taxRegimeComparisonFlatTaxSumAnnual: 'Somme des montants laissés pendant la détention',
    taxRegimeComparisonFlatTaxResaleNet: 'Net revente (prix de vente − solde crédit − IS sur plus-value)',
    taxRegimeComparisonFlatTaxTotalAccumulated: 'Total accumulé (non retiré)',
    taxRegimeComparisonFlatTaxRate: 'Taux flat tax (PFU)',
    taxRegimeComparisonFlatTaxAmount: 'Flat tax sur le retrait',
    taxRegimeComparisonFlatTaxCorporateOnGain: 'Impôt sur les sociétés sur la plus-value',
    taxRegimeComparisonFlatTaxTotalResaleTax: 'Total impôts revente (IS + flat tax)',
  },
}
