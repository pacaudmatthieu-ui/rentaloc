...
const S = {
  ...
  header: 'display:flex;align-items:center;gap:12px;border-bottom:3px solid #324344;padding-bottom:12px;margin-bottom:16px;',
  logo: 'width:44px;height:44px;border-radius:12px;background:#324344;color:#ffffff;font-weight:800;font-size:18px;display:flex;align-items:center;justify-content:center;',
  title: 'font-size:20px;font-weight:800;margin:0;color:#3F5354;',
  subtitle: 'font-size:11px;color:#6C6A64;margin:2px 0 0;',
  date: 'margin-left:auto;font-size:10px;color:#94918A;text-align:right;',
  h2: 'font-size:13px;font-weight:700;color:#324344;margin:18px 0 8px;text-transform:uppercase;letter-spacing:0.5px;',
  hero: 'background:#F5EDDA;border:1px solid #cfe9dd;border-radius:10px;padding:14px 16px;margin-bottom:6px;',
  heroFig: 'font-size:26px;font-weight:800;',
  heroPos: 'color:#3F5354;',
  heroNeg: 'color:#A34F38;',
  heroUnit: 'font-size:12px;color:#6C6A64;font-weight:500;',
  heroPhrase: 'font-size:11px;color:#403F3D;margin-top:4px;',
  grid: 'display:flex;flex-wrap:wrap;gap:8px;',
  tile: 'flex:1 1 30%;min-width:30%;background:#FAF4E6;border:1px solid #EDE5D2;border-radius:8px;padding:8px 10px;box-sizing:border-box;',
  tileV: 'font-size:13px;font-weight:700;',
  tileL: 'font-size:9px;color:#94918A;margin-top:2px;',
  table: 'width:100%;border-collapse:collapse;font-size:9.5px;',
  th: 'text-align:right;padding:5px 7px;border-bottom:2px solid #324344;color:#403F3D;font-weight:700;',
  thL: 'text-align:left;padding:5px 7px;border-bottom:2px solid #324344;color:#403F3D;font-weight:700;',
  td: 'text-align:right;padding:4px 7px;border-bottom:1px solid #EDE5D2;font-variant-numeric:tabular-nums;',
  tdL: 'text-align:left;padding:4px 7px;border-bottom:1px solid #EDE5D2;',
  neg: 'color:#A34F38;',
  pos: 'color:#3F5354;',
  kv: 'display:flex;justify-content:space-between;font-size:10.5px;padding:3px 0;border-bottom:1px dotted #EDE5D2;',
  cta: 'margin-top:20px;background:#3F5354;color:#ffffff;border-radius:10px;padding:12px 16px;font-size:11px;',
